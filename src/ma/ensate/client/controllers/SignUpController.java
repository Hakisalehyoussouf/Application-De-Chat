...
import ma.ensate.client.utils.Verification;
import ma.ensate.client.utils.generer;
...
public class SignUpController {
	...
	public void sign_up(ActionEvent event) throws Exception {
            ...
            Conversation conversation = new Conversation(nom1, prenom1, password1,email1,code1,type);
