        ...
        //   System.out.println(conversation_rec.getLoginState());
            ...
            if(!correctresult.equals(falseresult)){
                ...
                try { 
                    ...
                    String tempfilename1 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/username.txt";
                    ...
                    Parent root = FXMLLoader.load(getClass().getResource("/ma/ensate/client/vues/Dashboard.fxml"));
   ...
   /* private Stage stage;
    ...
    public void signUpOnAction(ActionEvent event) throws IOException {
                ...
                //Fermeture de l'ancienne fenetre
                    ...
                    //Ouverture de la nouvelle fenetre
                    Stage primaryStage = new Stage();
                    Parent root = FXMLLoader.load(getClass().getResource("/ma/ensate/client/vues/SignUp.fxml"));
                    primaryStage.initStyle(StageStyle.DECORATED.UNDECORATED);
