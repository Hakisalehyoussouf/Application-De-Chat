...
public class Controller_T implements Initializable {
  
    
    //security parameterz
    private String secret = "haki_saleh_youss";
    CompomentInter compomentInter;
    ...
    private static final String PRIVATE_KEY_FILE = "private_key_adnan.key";
    private static final String PUBLIC_KEY_FILE = "public_key_adnan.key";
    private static final String RECEIVER_PUBLIC_KEY_FILE = "public_key_salim.key";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String FILE_NAME = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/contacts_T.txt";
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
            ...
            while ((line = reader.readLine()) != null) {
               ...
               // Circle circle = new Circle(10, Color.GREEN);
                ...
                button.setStyle("-fx-stylesheet: \"@../vues/main_T.css\";");
        ...
        int port = 1234;
            ...
            try {
                ...
                String usernamefile2 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/username_T.txt";     
                ...
                new Thread(()->  {
        	        ...
        	        while (true) {
        	            Conversation conn1 = (Conversation) in.readObject();
                           ...
                           String MessageDecrypteEtDecote = Controller_T.decryptet(msg, this.privatekey, this.ReceiverpublicKey );
                            ...
                            String tempfilename1 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/temp_T.txt";
                            ...
                            * */
                            ...
                            if(currentContact.equals(user)){
                                ...
                                String tempfilename2 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/temp_T.txt";
        	        ...
        	        e.printStackTrace();
                        ...
                        Logger.getLogger(Controller_T.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public  void handleButtonAction(ActionEvent event){
        ...
        if(event.getSource()==btnLogout){
            ...
            //La recherche de Senderusername depuis le fichier
            String usernamefile1 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/username_T.txt";     
            String usernameline= "";
            try {
        ...
        if(event.getSource()==btnProfileManaging){ 
            ...
            //Tous le traitememnt necessaires sont ici!!!!!!!!!!!!!!!!!!!
            try {
                Parent newRoot = FXMLLoader.load(getClass().getResource("/ma/ensate/client/vues/ProfileAndContact_T.fxml"));
                Node node = (Node)event.getSource();
                Scene currentScene = (Scene)node.getScene();
                ...
                for (Node enfant : hb.getChildren()) {
                    ...
                    if (enfant instanceof VBox) {
                       ...
                       // System.out.println("C'est " + currentContact + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                        ...
                        String tempfilename3 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/temp_T.txt";     
                        try {
                            ...
                            while (line3 != null) {
                                ...
                                if(currentContact.equals(user3)){
                                    ...
                                    Platform.runLater(()->{
                                        //System.out.println("Listciew twstttttttttttttttttttttttttttttttt");
        ...
        if(event.getSource()==btnSend){
           ...
           String tempfilename4 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/temp_T.txt";
           ...
           //Ecriture sur le listView         
            String tempfilename5 = "C:/Users/hp/Desktop/Chat_App/src/ma/ensate/client/utils/temp_T.txt";     
            try {
            ...
            try {
                 MessageCrypteEtCode = Controller_T.encrypt(message, this.privatekey, this.ReceiverpublicKey );
                //System.out.println("La cle privee du client 1 : " + Component.privatekeyC1.getX());
                //System.out.println("La cle privee du client 2 : " + Component.privatekeyC2.getX());
